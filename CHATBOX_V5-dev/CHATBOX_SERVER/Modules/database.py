...
class Database:
    ...
    def get_user_by_user_id(self, user_id: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            resp = (
                ...
                .select("*")
                .eq("user_id", user_id)
                # Removed .single() to avoid PGRST116 error on new users
                .execute()
            )
            ...
            print(f"⚠️ Supabase fetch error in get_user_by_user_id: {e}")
            return None
    ...
    def get_user_by_id(self, user_id: int) -> Optional[Dict[str, Any]]:
        ...
        try:
            ...
            print(f"⚠️ Supabase fetch error in get_user_by_id: {e}")
            return None
