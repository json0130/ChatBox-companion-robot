...
def format_report(rows_on: Sequence[Dict], rows_off: Sequence[Dict]) -> str:
    ...
    out.append(
        ...
        "non-degenerate ones against each other. What distinguishes `identity` "
        "from the permutations is the TIMESCALE argument (E3: setpoint stability) "
        "and the noise-threshold sweep in E2's empirical half — not this table."
    )
